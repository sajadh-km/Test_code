...
int8_t ql_wifi_rssi_offset[] =
    ...
    || defined (CONFIG_QL_PROJECT_DEF_EG912U) || defined (CONFIG_QL_PROJECT_DEF_EC600U_EC_AC)
    {20, 23, 24, 24, 21};
...
const uint8_t ql_gsm_select =
    ...
    || defined (CONFIG_QL_PROJECT_DEF_EC600U_EU_AB) || defined (CONFIG_QL_PROJECT_DEF_EC600U_EC_AC) \
...
const ql_band_size_s ql_band_size =
   /*  gsm_size    lte_size  */
    ...
    {     2,          3      };
#elif defined (CONFIG_QL_PROJECT_DEF_EC200U_CN_MB) 
    {     2,          7      };
    ...
    {     0,          7      };
#elif defined (CONFIG_QL_PROJECT_DEF_EG700U_CN_LB)
	{     0,          9      };
...
#elif defined (CONFIG_QL_PROJECT_DEF_EG070U_CN_AC)
    {QUEC_BAND_LTE_BAND1, RDA_BAND_LTE_BAND1},
    {QUEC_BAND_LTE_BAND3, RDA_BAND_LTE_BAND3},
    {QUEC_BAND_LTE_BAND5, RDA_BAND_LTE_BAND5},
    {QUEC_BAND_LTE_BAND8, RDA_BAND_LTE_BAND8},
